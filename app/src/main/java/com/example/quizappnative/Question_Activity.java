...
import static com.example.quizappnative.Sets_Activity.category_id;
...
*/
       firestore.collection("Quiz").document("CAT" + String.valueOf(category_id))
           ...
           public void onComplete(@NonNull Task<QuerySnapshot> task) {
               if (task.isSuccessful()) {
                   ...
                   Toast.makeText(Question_Activity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
               }
    ...
    private void changeQuestion(){
        if(quesNum < questionList.size() -1){
            ...
            Intent intent = new Intent(Question_Activity.this,Score_Activity.class);
